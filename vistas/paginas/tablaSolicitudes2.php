      ...
      '<tr role="row" class="odd">';
        ...
        '<td  tabindex="0" class="sorting_1">
          ...
          '<td>';
            echo 
            '<div class="image">
                <button data-toggle="modal" data-target="#datosResolutor" id="IdSolicitudRes" class="btn btn-primary-outline onclick="valorresolutor('.$value['idsolicitud'].');">
                  <img src="'.$url_actual.'img/usuarios/resolutores/default.png"  width=50px height=50px class="img-circle elevation-2" alt="User Image">';
          }else{
            echo 
            '<td > ';
            echo 
              '<div class="image">
                <button  data-toggle="modal" data-target="#datosResolutor" id="IdSolicitudRes"
                      ...
                      onclick="valorresolutor('.$value['idsolicitud'].');" >
                    <img src="'.$url_actual.'img/usuarios/resolutores/'.$value["fotoresolutor"].'"  width=50px height=50px class="img-circle elevation-2" alt="User Image">
                     ';
          }
                        echo 
            ...
            '<td>';
              ...
              <td >';
                ...
                '<div class="info-box bg-gradient-warning" ><span class="info-box-icon"><i class="fas fa-exclamation-triangle"></i></span>
                  <div class="info-box-content"><span class="info-box-text">Tiempo Transcurrido</span>
                    <span class="info-box-number">';
                        if ($horaAct>0){ echo $horaAct.' horas con '; }
                        if ($minAct>0){ echo $minAct.' minutos'; }
                ...
                case 2:
                    ...
                    echo '<div class="info-box bg-gradient-primary"><span class="info-box-icon"><i class="fas fa-user-check"></i></span>
                      <div class="info-box-content"><span class="info-box-text">Solicitud Atendia</span>';
                ...
                case 3:
                  ...
                  break;
                case 4:
                    echo '<span class="badge badge-danger">Cancelada</span></td><td>';
                    echo '<div class="info-box bg-gradient-danger"><span class="info-box-icon"><i class="fas fa-comment-slash"></i></span>
                      <div class="info-box-content"><span class="info-box-text">Solicitud Cancelada</span>';
                    echo '<div class="progress"><div class="progress-bar" style="width: 100%"></div></div>';
                  break;
                default:
                  break;
      ...
      echo '<td>
          <div class="btn-group">
            <button  data-toggle="modal" data-target="#actualizaStatus" id="IdStatus1"
                  ...
                  if ($value['statussolicitud']!=1 && $value['statussolicitud']!=3) echo ' disabled ';
            ...
            <button  data-toggle="modal" data-target="#actualizaStatus" id="IdStatus2"
                  ...
                  if ($value['statussolicitud']!=3) echo ' disabled ';
