      ...
      <form method="POST"   enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="input-group col-xs-3">
              ...
              <input maxlength="20" id="amaterno" type="text"  onKeyUp="this.value=this.value.toUpperCase();" class="form-control" name="amaterno"  required autocomplete="secondname" autofocus placeholder="Puesto del colaborador">
