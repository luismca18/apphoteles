...
<div id="cuerpo" class="content-wrapper" style="min-height:274px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Services requested by guest</h1>
          ...
          <div class="col-sm-10 col-md-10 col-lg-10">            
            <div class="card card-success">
              <div class="card-header">
                  <h3 class="card-title mr-3 mt-2">Total Requests</h3>
                <div id="vtnFiltro01" class="toast bg-warning" data-autohide="false" > 
                  <div class="toast-header"> 
                    <strong id="etiqueta" class="mr-auto">Unassigned</strong>
                ...
                <div id="vtnFiltro02" class="toast bg-info" data-autohide="false" > 
                  <div class="toast-header"> 
                    <strong id="etiqueta" class="mr-auto">Served</strong>
                ...
                <div id="vtnFiltro03" class="toast bg-success" data-autohide="false" > 
                  <div class="toast-header"> 
                    <strong id="etiqueta" class="mr-auto">In Process</strong>
                ...
                <div id="vtnFiltro04" class="toast bg-danger" data-autohide="false" > 
                  <div class="toast-header"> 
                    <strong id="etiqueta" class="mr-auto">Cancelled</strong>
                    <button type="button" class="ml-2 mb-1 close" data-dismiss="toast"  onclick="Seleccion(0)">x</button>
                  </div>
                </div>
          ...
          <div class="col-sm-6 col-md-6 col-lg-6">            
            <div class="card card-success">
              <div class="card-header">
                ...
                <h3 class="card-title mr-3 mt-2">Total Requests pending</h3>
                <a href="http://www.vixdrix.com/elige-tu-plan/">
                <button type="button" class="btn btn-danger btn-lg mt-3" >You have exhausted the free monthly tickets, update your plan to see the new tickets, click here
                </button></a>
                </div>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
        ...
        <div class="modal-header bg-info">
          ...
          <h4 class="modal-title text center">Request data</h4>
...
<div class="modal fade" role="dialog" id="datosResolutor">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header bg-info">
          <h4 class="modal-title text center">Select the collaborator</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <div class="modal-footer d-flex justify-content-between">
            <div class="col-sm-12 justify-content">
               ...
               <button type="button" class="btn btn-info" data-dismiss="modal" onclick="ActualizaResolutor();">>Assign collaborator</button>
            </div>
        </div>
